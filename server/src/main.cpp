...
/** @project demo server
 * 
 * Firstly, this server would not be possible without boost.asio and boost.beast.
 * 
 ...
 * 
 * Another excellent shout-out to @lefticus (github; host of cppcast) for providing the 
 * foundation for the C++ Template.
 * While I have removed most of it, for ease of distribution and not needing automatic CI for this demo,
 * It was nevertheless fundamental in its exposition of model boilerplate for a C++ build system.
 * 
 * This work is also derivative of my own: the containers that host my website scale with 
 * load balancers and containers; not concurrent, singular servers. It was therefore unnecessary 
 * to implement this kind concurrency for my website -- but the basis for the server, its argument 
 * mapping, containment and deployment can be found at @e-dant/shoestring.
 * 
 */
